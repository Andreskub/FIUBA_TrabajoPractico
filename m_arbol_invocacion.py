    ...
    #Si la funcion recorrida tiene invocaciones las recorre
        ...
        for invocacion_de_funcion in range(len(invocaciones)):
            ...
            #Sino es la primera, se llama a si misma y pasa la longitud del string pero en espacios
                ...
                formatear_arbol_invocacion(diccionario_informacion, invocaciones[invocacion_de_funcion], " " * len(str_invocacion))

def graficar_arbol_invocaciones(diccionario_informacion):
    '''[Autor: Andrés Kübler]
    ...
    try:
        formatear_arbol_invocacion(diccionario_informacion)
